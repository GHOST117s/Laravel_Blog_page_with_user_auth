          ...
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-5">
              <div class="mb-3">
                ...
                <input id="title" type="text" name="title" class="w-full border border-gray-400 p-2 rounded-lg">
              </div>
              <div class="mb-3">
                <label for="body" class="block text-gray-700 font-medium mb-2">Body</label>
                <textarea id="body" name="body" rows="3" class="w-full border border-gray-400 p-2 rounded-lg"></textarea>
              </div>
